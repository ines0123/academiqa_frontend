  ...
  return (
    <nav className="midnavbar">
      <div className="cont">
        ...
        <Link to="/student/profile" className="profileMid" style={{width: role ==="admin"? "300px":""}}>
          <img src={teacherPhoto} alt="teacher" className="profilePhotoMid" />
          <div className="accountNameMid">Mohamed Aziz mansour Elloumin</div>
        </Link>
        {children}
        { role !== "admin" && (<button className="BellbuttonMid" onClick={toggleVisibility}>
          <svg viewBox="0 0 448 512" className="bellMid">
            <path
        ...
        <button className="LogoutbuttonMid">
          <svg viewBox="0 0 512 512" className="logouttMid">
